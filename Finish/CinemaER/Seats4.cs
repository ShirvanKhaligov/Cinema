...
namespace CinemaER
{
    public partial class Seats4 : Form
    {
        public static Form now_form4;
        ...
        public static List<int> SeatNum4 = new List<int>();
        public Seats4()
        {
            InitializeComponent();
            now_form4 = this;
        ...
        public void SeatData(object obj, EventArgs e)
        {
            ...
            if (newseat.BackColor == Color.White)
            {
                ...
                SeatNum4.Add(Convert.ToInt32(newseat.Text));
                resaultText.Text += newseat.Text + ", ";
            }
            else
            {
                newseat.BackColor = Color.White;
                SeatNum4.Remove(Convert.ToInt32(newseat.Text));
                resaultText.Text = "";
                foreach (var num in SeatNum4)
                {
        ...
        private void seat4_close(object sender, FormClosingEventArgs e)
        {
            foreach (var f in Controls)
            {
                foreach (var h in SeatNum4)
