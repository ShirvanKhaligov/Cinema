...
namespace CinemaER
{
    public partial class Seats3 : Form
    {
        public static Form now_form3;
        ...
        public static List<int> SeatNum3 = new List<int>();
        public Seats3()
        {
            InitializeComponent();
            now_form3 = this;
        ...
        public void SeatData(object obj, EventArgs e)
        {
            ...
            if (newseat.BackColor == Color.White)
            {
                ...
                SeatNum3.Add(Convert.ToInt32(newseat.Text));
                resaultText.Text += newseat.Text + ", ";
            }
            else
            {
                newseat.BackColor = Color.White;
                SeatNum3.Remove(Convert.ToInt32(newseat.Text));
                resaultText.Text = "";
                foreach (var num in SeatNum3)
                {
