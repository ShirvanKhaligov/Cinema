    ...
    public partial class Seats : Form
    {
        ...
        public void SeatData(object obj, EventArgs e)
        {
            ...
            if (newseat.BackColor == Color.White)
            {
                ...
                SeatNum.Add(Convert.ToInt32(newseat.Text));
                resaultText.Text += newseat.Text+", ";
            }
            else
            {
                    newseat.BackColor = Color.White;
                SeatNum.Remove(Convert.ToInt32(newseat.Text));
                resaultText.Text = "";
        ...
        private void seat_close(object sender, FormClosingEventArgs e)
        {

            foreach (var f in Controls)
            {
                foreach (var h in Seats.SeatNum)
